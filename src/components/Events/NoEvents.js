    ...
    <div>
      <div className="text-center px-6 py-4">
        <div className="py-8">
          <div className="mb-4">
            <svg
              className="inline-block fill-current text-gray-600 h-16 w-16"
          ...
          <p className="text-gray-600 max-w-xs mx-auto mb-6">
            No events found as you are not logged in. Please login via google
            login button below.
          </p>
